...
class SimpleRF:
    ...
    def plotCM(self,tipo):
        ...
        img2 = 'amazonforest/ic/data/clinvar/02_training/plot_rf_'+tipo+'_cm.png'
    ...
    def plotRoc(self,tipo):
        ...
        img = 'amazonforest/ic/data/clinvar/02_training/plot_rf_'+tipo+'_roc.png'
        plt.savefig(img, format='png')
        plt.close()
    ...
    def runModel(self):
        ...
        elif (self.typeCategory == CategoryEnum.Stand):
            self.runModelStand()
    ...
    def runModelOneHot(self):
        ...
        for train_index, test_index in loso.split(x):
            ...
            filerf = 'amazonforest/ic/data/clinvar/02_training/predict_rf_'+str(i)+'.sav'
        ...
        self.dfF1Acuracy.to_csv("amazonforest/ic/data/clinvar/02_training/acuracy_onehot_rf.csv", index=False)
        self.plotCM("onehot")
        self.plotRoc ("onehot")
    ...
    def runModelEncode(self):
        ...
        for train_index, test_index in loso.split(x):
            ...
            filerf = 'amazonforest/ic/data/clinvar/02_training/predict_rf_label_'+str(i)+'.sav'
        ...
        self.dfF1Acuracy = pd.DataFrame(data=dataF1)
        self.dfF1Acuracy.to_csv("amazonforest/ic/data/clinvar/02_training/acuracy_label_rf.csv", index=False)        
        self.plotCM("label")
        self.plotRoc ("label")
    ...
    def runModelEncodeScalar(self):
        ...
        for train_index, test_index in loso.split(x):
            ...
            import pickle
            filerf = 'amazonforest/ic/data/clinvar/02_training/predict_rf_max_'+str(i)+'.sav'
            pickle.dump(model, open(filerf, 'wb'))
        ...
        self.dfF1Acuracy = pd.DataFrame(data=dataF1)
        self.dfF1Acuracy.to_csv("amazonforest/ic/data/clinvar/02_training/acuracy_max_rf.csv", index=False)
        self.plotCM("max")
        self.plotRoc ("max")
