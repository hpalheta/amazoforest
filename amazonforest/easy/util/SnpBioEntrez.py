...
def get_snp(q):
    ...
    #https://www.ncbi.nlm.nih.gov/snp/?term=rs1799931%5BAll%20Fields%5D&cmd=DetailsSearch
...
#https://eutils.ncbi.nlm.nih.gov/entrez/eutils/elink.fcgi?db=snp&id=328

#snp = get_snp(["RS1799931"])

#snp = get_snp(["RS1799931"])

#https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=gene&id=2&retmode=xml

#https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=snp&id=232&retmode=xml

#https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esummary.fcgi?db=snp&id=232";
